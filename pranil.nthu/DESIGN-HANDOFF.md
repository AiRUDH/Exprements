# e93d45d4-5182-4fc0-a619-930e1e3085cf implementation handoff

This archive is the source of truth for turning the design into production code. Start from `accretion-portfolio.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `accretion-portfolio.html`
...
- A single self-contained `accretion-portfolio.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `accretion-portfolio.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `accretion-portfolio.html`

## Styles
- `styles/accretion.css`
...
1. Inspect `accretion-portfolio.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
